...
int main()
{
	...
	//music
	mciSendString(L"open BB.mp3 alias music", 0, 0, 0);//open bgm
...
void saySomething()
{
	...
	for (int i = 0; i < 50; i++)
	{
		...
		settextstyle((i + 1) > 20 ? 20 : i + 1, 0, L"黑体"); // 设置字体 
		//printf("fontH: %d\n", i+1);
		//Sleep(10);
		outtextxy(x - 100, y - 150, L"吉吉国王，你好呀！");     //在指定的位置去输出字符

		outtextxy(x, y - 100, L"作为你的大朋友，我想大声说：");
	...
	outtextxy(400, 50, L"Never look back.");
	Sleep(2000);
	outtextxy(380, 100, L"Never settled down.");
	Sleep(2000);
	outtextxy(370, 150, L"It will stop raining.");
	Sleep(2000);
	outtextxy(400, 200, L"It will be sunny.");
	Sleep(2000);
	outtextxy(100, 250, L"Nothing is  gonna be so bad  you have to force yourself to be good.");
	Sleep(2000); 
	outtextxy(330, 300, L"And then，be proud of your life.");
	Sleep(2000);
	outtextxy(360, 350, L"Be proud of your life.");
	Sleep(2000);

	cleardevice();
	settextstyle(25, 0, L"宋体");
	outtextxy(400, 150, L"走过的岁月见证了我们的成长。");
	Sleep(1000);
	outtextxy(450, 200, L"往前走的路从来都不平坦。");
	Sleep(1000);
	outtextxy(500, 250, L"所以以后要一起加油鸭！！！");
	Sleep(1000);
	//settextstyle(35, 0, L"黑体");
	outtextxy(650, 300, L"————来自毛毛。");
	Sleep(1000);
	//outtextxy(350, 300, L"考研加油呀");
